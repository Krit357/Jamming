...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      searchResults: [
        { name: 'Rick Ashely', artist: 'Roll', album: 'Never gonna give you up', id: 1 },
        { name: 'Rock Roll', artist: 'artist1', album: 'album1', id: 2 },
        { name: 'Never gonna give you up', artist: 'artist2', album: 'album2', id: 3 }
      ],
